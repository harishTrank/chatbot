 ...
 */
const sendCoinDeductionNotification = async (actor, receiver, io, notificationText) => {
  try {
    ...
    console.log("Err in coin-deducted notification service: ", err);
    return err;
  }
};

module.exports = sendCoinDeductionNotification;
